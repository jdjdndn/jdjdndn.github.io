  ...
  <main class="about-page">
      ...
      <div class="card">
        ...
        <div class="space-v">
          ...
          <div class="space-v-sm">
            <strong>QQ：2667389861</strong>
            <strong>微信：wcbblll</strong>
          </div>
        </div>
      </div>
