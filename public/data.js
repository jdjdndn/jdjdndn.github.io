  ...
  // ────────────── 电商 ──────────────
  {
    ...
    sections: [
      ...
      },
      {
        title: '淘宝',
        items: [
          { name: '领券中心', link: 'https://s.click.taobao.com/mKkcUWj' },
          { name: '好货快抢', link: 'https://s.click.taobao.com/7OgA6Oj' },
          { name: '天猫超市福利攻略', link: 'https://s.click.taobao.com/ToO76Oj' },
          { name: '爱淘宝U选好价', link: 'https://s.click.taobao.com/0c766Oj' },
          { name: '猫超省钱购', link: 'https://s.click.taobao.com/Cwg16Oj' },
          { name: '淘宝签到领福利', link: 'https://s.click.taobao.com/K8G06Oj' },
          { name: '淘宝秒杀福利攻略', link: 'https://s.click.taobao.com/yRGEUWj' },
          { name: '百亿补贴福利攻略', link: 'https://s.click.taobao.com/5tVCUWj' },
          { name: '手机以旧换会场', link: 'https://s.click.taobao.com/MNsr5Oj' },
          { name: '3c数码以旧换新会场', link: 'https://s.click.taobao.com/iGc7UWj' },
          { name: '淘宝省钱购', link: 'https://s.click.taobao.com/8KZm5Oj' },
        ],
      },
      {
        title: '拼多多',
    ...
    sections: [
      {
        title: '美团酒店',
        items: [
          { name: '美团酒店旅行送福利，领百元券包再下单', link: 'https://dpurl.cn/PECjbS4z' },
          { name: '美团民宿暑期大促销，抢100元红包', link: 'https://kurl06.cn/txhDVZ' },
          { name: '亲子、学生、商旅等各种活动', link: 'https://kurl05.cn/txhDC0' },
          { name: '美团特惠酒店在线预订，领个红包再下单', link: 'https://kurl07.cn/txhDKW' },
          { name: '暑期活动来袭，多重好礼快领', link: 'https://dpurl.cn/DrEbBe0z' },
          { name: '美团特惠酒店在线预订2', link: 'https://dpurl.cn/vj61H92z' },
        ],
      },
      {
        title: '同程旅行',
    ...
    sections: [
      {
        title: '京东外卖',
        items: [
          { name: '京东大牌冰饮0.1元起', link: 'https://u.jd.com/xG2Oi8p' },
          { name: '京东爆品双份低至9.9', link: 'https://u.jd.com/xD23Rsp' },
          { name: '品质外卖上京东，百亿补贴限时领', link: 'https://u.jd.com/xr28czK' },
          { name: '20元外卖百亿补贴券', link: 'https://u.jd.com/xD2uYrG' },
          { name: '京东团购频道大牌特价', link: 'https://u.jd.com/xa216Zi' },
        ],
      },
      {
        title: '淘宝闪购',
        items: [
          { name: '闪购零售品牌日', code: '￥PECZT6xUxo9￥' },
          { name: '淘宝闪购-爆品好价', code: '￥9E2VT6xgm60￥' },
          { name: '饿了么外卖', code: '￥bL6GT6xg9rK￥' },
          { name: '来闪购以下可赢免单福利', code: '￥K6QQT6x6Vt4￥' },
          { name: '淘宝闪购', code: '￥svutT6xTfoQ￥' },
          { name: '闪购超级品牌日', code: '￥bW6IT6xhWgp￥' },
          { name: '饿了么霸王餐', code: '￥GWMiT6x6syn￥' },
          { name: '社群限量福利', code: '￥GpKCT6xhHgq￥' },
          { name: '饿了么21城消费日活动', code: '￥x7kAT6x6CWu￥' },
          { name: '饿了么赚现金活动', code: '￥T6xhHBD￥' },
          { name: '闪购夜宵专场', code: '￥OaxJT6xKUBO￥' },
          { name: '天天领红包', code: '￥yThYTSo03Jq￥' },
          { name: '饿了么活动', code: '￥HVj2TSoXaOy￥' },
          { name: '饿了么红包领不停', code: '￥DtNbT6xiANF￥' },
          { name: '饿了么零售会场', code: '￥XOdxT6xRkMt￥' },
          { name: '闪购果蔬日日鲜', code: '￥a2KkTSo2h9K￥' },
          { name: '猫超品牌馆', code: '￥5h2xTSo2RQI￥' },
        ],
      },
      {
        title: '电影票 · 快递',
  ...
  // ────────────── 生活 ──────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          { name: '京东大牌冰饮0.1元起', link: 'https://u.jd.com/xG2Oi8p' },
          { name: '京东9块9包邮特惠', link: 'https://kurl05.cn/txhTDI' },
          { name: '拼多多超低价好货疯抢', link: 'https://p.pinduoduo.com/jLvkvF7I?sc=EFAC' },
          { name: '拼多多官方领券中心', link: 'https://p.pinduoduo.com/njCkI5as?sc=EFAC' },
        ],
      },
    ],
  },
